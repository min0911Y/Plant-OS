...
uint32_t IP2UINT32_T(uint8_t *ip) {
  char *endptr;
  uint8_t ip0 = (uint8_t)strtol((char *)ip, &endptr, 10);
  uint8_t ip1 = (uint8_t)strtol(endptr + 1, &endptr, 10);
  uint8_t ip2 = (uint8_t)strtol(endptr + 1, &endptr, 10);
  uint8_t ip3 = (uint8_t)strtol(endptr + 1, NULL, 10);
