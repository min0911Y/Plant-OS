...
static void socket_udp_send(struct Socket* socket,
                            uint8_t* data,
                            uint32_t size) {
...
static void socket_tcp_send(struct Socket* socket,
                            uint8_t* data,
                            uint32_t size) {
...
static void SocketServer_Send(struct SocketServer* server,
                              uint8_t* data,
                              uint32_t size) {
...
struct Socket* Socket_Find(uint32_t dstIP,
                           uint16_t dstPort,
                           uint32_t srcIP,
                           uint16_t srcPort,
                           uint8_t protocol) {
...
struct SocketServer* SocketServer_Alloc(void (*Handler)(struct Socket* socket,
                                                        void* base),
                                        uint32_t srcIP,
                                        uint16_t srcPort,
                                        uint8_t protocol) {
