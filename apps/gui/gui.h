...
struct super_window {
  ...
  struct SHEET *(*create_sheet)(super_window_t *super_window, int xsize, int ysize, int x, int y,
                                int pos);
  void (*draw_sheet)(super_window_t *super_window, struct SHEET *sht, int x, int y, int x1, int y1,
                     color_t color);
  void (*puts_sheet)(super_window_t *super_window, struct SHEET *sht, char *s, int x, int y,
                     color_t color);
  void (*slide_sheet)(super_window_t *super_window, struct SHEET *sht, int x, int y);
  void (*updown_sheet)(super_window_t *super_window, struct SHEET *sht, int pos);
  void (*handle_left)(window_t *window, gmouse_t *gmouse);
  void (*handle_right)(window_t *window, gmouse_t *gmouse);
  void (*handle_stay)(window_t *window, gmouse_t *gmouse);
...
button_t *create_button(super_window_t *super_window, char *text, int xsize, int ysize, int x,
                        int y, void (*click)(button_t *button));
...
void boxfill(vram_t *vram, int xsize, color_t c, int x0, int y0, int x1, int y1);
bool Collision(int x, int y, int w, int h, int x1, int y1);
struct SHEET {
  vram_t        *buf;
