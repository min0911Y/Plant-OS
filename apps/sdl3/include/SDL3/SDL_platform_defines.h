...
/* Plant OS port: host compiler platform macros do not describe the target ABI. */
#if defined(PLANT_ARCH_I386) || defined(PLANT_ARCH_X86_64)
#define SDL_PLATFORM_PLOS 1
#define SDL_PLATFORM_PRIVATE 1
#define SDL_PLATFORM_PRIVATE_NAME "Plant OS"
...
#if !defined(SDL_PLATFORM_PLOS) && (defined(linux) || defined(__linux) || defined(__linux__))
...
#if !defined(SDL_PLATFORM_PLOS) && (defined(__unix__) || defined(__unix) || defined(unix))
