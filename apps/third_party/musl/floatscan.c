...
static long long scanexp(scan_input_t *f, int pok)
{
	int c;
	int x;
	long long y;
...
static long double decfloat(scan_input_t *f, int c, int bits, int emin, int sign, int pok)
{
	uint32_t x[KMAX];
...
static long double hexfloat(scan_input_t *f, int bits, int emin, int sign, int pok)
{
	uint32_t x = 0;
	long double y = 0;
	long double scale = 1;
...
long double plant_floatscan(scan_input_t *f, int prec, int pok)
{
	int sign = 1;
	size_t i;
	int bits;
