// See apps/glfw/UPSTREAM.md for Plant OS downstream changes.
//========================================================================
...
#if defined(_GLFW_PLANTOS)
 #include "plantos_platform.h"
#else
 #define GLFW_PLANTOS_WINDOW_STATE
 #define GLFW_PLANTOS_LIBRARY_WINDOW_STATE
#endif
...
#define GLFW_PLATFORM_LIBRARY_WINDOW_STATE \
        ...
        GLFW_PLANTOS_LIBRARY_WINDOW_STATE \
